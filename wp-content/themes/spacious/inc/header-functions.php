...
function spacious_header_image_markup( $html, $header, $attr ) {
	...
	if( ! empty( $header_image ) ) {
		$output .= '<img src="https://blog.dsmtool.com/wp-content/uploads/2017/10/cropped-blog-header-1.jpg'/* --ilya fix a header url ilya-- . get_site_url().'/'  . esc_url( $header_image ) */ . '" class="header-image" width="' . get_custom_header()->width . '" height="' . get_custom_header()->height . '" alt="' . esc_attr( get_bloginfo( 'name', 'display' ) ) . '">';
	}
