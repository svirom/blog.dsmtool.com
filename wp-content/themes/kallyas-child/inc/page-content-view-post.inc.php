...
<div id="post-<?php the_ID(); ?>" <?php post_class('kl-single-layout--'.$blog_layout); ?>>
    ...
    <?php if ( ( in_category(9) ) || ( in_category(1005) ) ) { ?>
    <h1 class="page-title kl-blog-post-title entry-title news_title" <?php echo WpkPageHelper::zn_schema_markup('title'); ?>><?php the_title(); ?></h1>
    <?php } ?>
