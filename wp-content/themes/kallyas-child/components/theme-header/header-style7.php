...
/**** TOP RIGHT */
if(zn_check_components('flags')) add_action( 'zn_head__top_right', 'zn_wpml_language_switcher', 50 ); // WPML LANGUAGE SWITCHER //ilya changed it from 10 to 50 so it loads at the end
...
/*ilya hide default searchbox*/ //if(zn_check_components('search_box')) add_action( 'zn_head__top_right', 'zn_header_searchbox_def', 60 ); // search box
...
add_action( 'zn_head__main_right', 'zn_woocomerce_cart_init', 10 ); // CART PANEL //ilya changed 1 to 10
add_action( 'zn_head__main_right', 'zn_header_calltoaction', 20 ); // CALL TO ACTION BUTTON //ilya changed 2 to 20
